...
schron :- format('czy masz mozliwosc ukrycia sie w schronie przeciwatomowym?').
kombinezon_przeciwpromienny :- format('czy posiadasz kombinezon przeciwpromienny?').
barykada :- format('czy mozesz zabarykadowac drzwi?').
...
hypothesize('jestes smiertelnie napromieniowany') :- smierc_przez_napromieniowanie, !.
...
smierc_przez_napromieniowanie :-
       weryfikuj(kombinezon_przeciwpromienny),
       weryfikuj(schron).
zastrzelisz_sie :-
                weryfikuj(bron),
